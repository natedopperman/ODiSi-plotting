...
positionFLT1 = pd.read_pickle(r"pickle/FLT1position.pkl")
positionFLT2 = pd.read_pickle(r"pickle/FLT2position.pkl")
positionFLB1 = pd.read_pickle(r"pickle/FLB1position.pkl")
positionFLB2 = pd.read_pickle(r"pickle/FLB2position.pkl")
valuesFLT1 = pd.read_pickle(r"pickle/FLT1values.pkl")
valuesFLT2 = pd.read_pickle(r"pickle/FLT2values.pkl")
valuesFLB1 = pd.read_pickle(r"pickle/FLB1values.pkl")
valuesFLB2 = pd.read_pickle(r"pickle/FLB2values.pkl")
timeFLT1 = pd.read_pickle(r"pickle/FLT1time.pkl")
timeFLT2 = pd.read_pickle(r"pickle/FLT2time.pkl")
timeFLB1 = pd.read_pickle(r"pickle/FLB1time.pkl")
timeFLB2 = pd.read_pickle(r"pickle/FLB2time.pkl")
...
gT11, gT12 =  1266, 4622 ### flt1
gT21, gT22 =  2282, 5350 ### flt2
gB11, gB12 =  1553, 4749 ### flb1
gB21, gB22 =  1306, 4384 ### flb2
...
gs = gridspec.GridSpec(2, 4, width_ratios=[30, 1, 30, 1])  # 2 rows, 4 columns

### FLT1 ######################################################################

X, Y = np.meshgrid(timeFLT1[0:t2], positionFLT1[gT11:gT12])

ax1 = plt.subplot(gs[0, 0])
color_plot = ax1.pcolormesh(X, Y, valuesFLT1[gT11:gT12, 0:t2], cmap='bwr', vmax = 1.5*stdFLT1, vmin = -1.5*stdFLT1)
ax1.set_xlabel('Time (sec)')
ax1.set_ylabel('Position along fiber (m)')
ax1.set_title("Strain in FLT1")
...
X, Y = np.meshgrid(timeFLB1[0:t2], positionFLB1[gB11:gB12])

ax2 = plt.subplot(gs[1, 0])
color_plot = ax2.pcolormesh(X, Y, valuesFLB1[gB11:gB12, 0:t2], cmap='bwr', vmax = 1.5*stdFLB1, vmin = -1.5*stdFLB1)
ax2.set_xlabel('Time (sec)')
ax2.set_ylabel('Position along fiber (m)')
ax2.set_title("Strain in FLB1")
...
X, Y = np.meshgrid(timeFLT2[0:t2], positionFLT2[gT21:gT22])

ax3 = plt.subplot(gs[0, 2])
color_plot = ax3.pcolormesh(X, Y, valuesFLT2[gT21:gT22, 0:t2], cmap='bwr', vmax = 1.5*stdFLT2, vmin = -1.5*stdFLT2)
ax3.set_xlabel('Time (sec)')
ax3.set_ylabel('Position along fiber (m)')
ax3.set_title("Strain in FLT2")
...
X, Y = np.meshgrid(timeFLB2[0:t2], positionFLB2[gB21:gB22])

ax4 = plt.subplot(gs[1, 2])
color_plot = ax4.pcolormesh(X, Y, valuesFLB2[gB21:gB22, 0:t2], cmap='bwr', vmax = 1.5*stdFLB2, vmin = -1.5*stdFLB2)
ax4.set_xlabel('Time (sec)')
ax4.set_ylabel('Position along fiber (m)')
ax4.set_title("Strain in FLB2")
